...
Compare-Directory -SiteURL "https://icewm.sharepoint.com/sites/ICEWaterEngineering1" -SourceFolderPath "C:\ESD" -LibraryName "Documents" -LogFile "c:\tmp\Compare_Tree_File.log"
